      ...
      <div className="space-y-6 w-full max-w-7xl mx-auto">
        <div className="bg-white border border-border-color p-5 rounded-[var(--radius-lg)] shadow-lg flex items-center justify-between">
          ...
          <button
            ...
            className="px-3.5 py-2 bg-page-bg hover:bg-zinc-700 text-zinc-200 text-xs font-bold rounded-[var(--radius-sm)] border border-border-color"
          >
            Mark All as Read
          </button>
        </div>
          ...
          {notifications.map((n) => (
            <div
              ...
              className={`bg-white border p-4 rounded-[var(--radius-md)] shadow transition-all flex items-start justify-between gap-4 ${
                n.unread ? 'border-[#722F37]' : 'border-border-color'
              }`}
            >
              <div className="flex items-start gap-3">
                <div className="p-2 rounded-[var(--radius-sm)] bg-page-bg border border-border-color text-primary">
              ...
              {n.actionUrl && (
                <Link
                  href={n.actionUrl}
                  className="px-3 py-1.5 bg-primary hover:bg-dark-blue text-white text-xs font-bold rounded-[var(--radius-sm)] border border-dark-blue shrink-0 flex items-center gap-1"
                >
                  <span>Action</span>

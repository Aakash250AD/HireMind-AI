  ...
  return (
    <DashboardLayout role="hr">
      <div className="space-y-6 w-full max-w-7xl mx-auto">
        {/* Header */}
        <div className="bg-white border border-border-color p-6 rounded-[var(--radius-lg)] shadow-lg">
          ...
          <div className="flex items-center gap-4 pt-2">
            <button
              ...
              className={`px-5 py-2.5 rounded-[var(--radius-md)] text-xs font-bold border transition-all flex items-center gap-2 ${
                theme === 'dark'
                  ? 'bg-primary text-white border-dark-blue shadow'
        ...
        <div className="bg-white border border-border-color p-6 rounded-[var(--radius-lg)] shadow-lg space-y-4">
          ...
          {cleared && (
            <div className="p-3 bg-emerald-950/60 border border-emerald-800 text-emerald-300 text-xs font-semibold rounded-[var(--radius-sm)] flex items-center gap-2">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <button
              ...
              className="px-4 py-2.5 bg-page-bg hover:bg-zinc-700 text-zinc-200 text-xs font-bold rounded-[var(--radius-md)] border border-border-color transition-colors flex items-center gap-2"
            >
            ...
            <button
              ...
              className="px-5 py-2.5 bg-error-bg hover:bg-rose-900 text-error text-xs font-bold rounded-[var(--radius-md)] border border-error transition-colors flex items-center gap-2"
            >
          ...
          <form onSubmit={handleSave} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full p-2.5 bg-page-bg border border-border-color rounded-[var(--radius-sm)] text-xs text-white focus:outline-none focus:border-[#722F37]"
              />
            ...
            <div className="bg-page-bg border border-border-color p-4 rounded-[var(--radius-md)] space-y-2">
            ...
            <button
              type="submit"
              className="px-5 py-2.5 bg-primary hover:bg-dark-blue text-white text-xs font-extrabold rounded-[var(--radius-sm)] shadow border border-dark-blue transition-colors"
            >

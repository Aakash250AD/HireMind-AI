    ...
    <DashboardLayout role="hr">
      <div className="space-y-6 w-full max-w-7xl mx-auto">
        ...
        <div className="bg-white border border-border-color p-6 rounded-[var(--radius-lg)] shadow-lg flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 bg-page-bg p-1.5 rounded-[var(--radius-sm)] border border-border-color text-xs font-semibold">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          <div className="bg-white border border-border-color p-4 rounded-[var(--radius-md)] shadow">
